<script>
	...
	*/
	...
	function getchainValidationRules(rule) {
		return validation = {
			"admin" : {
				"chain" : {
					"required": {
				...
				"hallmark_id" : {
					"required": {
						"value": true,
						"message": "Please choose the hallmark"
					},
				},
            },
        };
	...
	*/
	$(document).on('blur', '.pos_validate', function() {
		...
		var validation 		= getchainValidationRules(rule);
	...
	/**
	* Create/Update the chain form
	*/
	$('#chain-submit').click(function(event){
